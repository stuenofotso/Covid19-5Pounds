...
object ForecastRF {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val  paramGrid = new ParamGridBuilder()
      .addGrid(rfr.maxBins, Array(250,300,350,400))
      .addGrid(rfr.maxDepth, Array(10,20,30))
      .build()
...
//      .setStages(Array(gbt))
    ...
    println(s"Learned regression RFR model:\n ${model.toString()}")

    model.save("models/RFRRegressionModel.ml")
  }
